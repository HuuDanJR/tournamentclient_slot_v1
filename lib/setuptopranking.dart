...
import 'package:tournament_client/widget/loader_dialog.dart';
import 'package:tournament_client/screen/admin/view/page.dart';
import 'package:tournament_client/lib/socket/socket_manager.dart';

class SetupTopranking extends StatefulWidget {
  SocketManager? mySocket;
  SetupTopranking({Key? key, this.mySocket}) : super(key: key);

  @override
  State<SetupTopranking> createState() => _SetupToprankingState();
}

class _SetupToprankingState extends State<SetupTopranking> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          TextButton.icon(
              ...
              icon: Icon(Icons.refresh_rounded,color:MyColor.white),
