...
class HomeMongoTestCopy extends StatefulWidget {
  HomeMongoTestCopy({
    Key? key,
    required this.url,
  ...
  final String url;
  @override
  State<HomeMongoTestCopy> createState() => _HomeMongoTestCopyState();
}

class _HomeMongoTestCopyState extends State<HomeMongoTestCopy> {
  IO.Socket? socket;
